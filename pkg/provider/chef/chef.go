...
func (providerchef *Providerchef) DeleteSecret(ctx context.Context, remoteRef v1beta1.PushRemoteRef) error {
	return fmt.Errorf("not implemented")
}

// Not Implemented PushSecret.
func (providerchef *Providerchef) PushSecret(ctx context.Context, value []byte, remoteRef v1beta1.PushRemoteRef) error {
	return fmt.Errorf("not implemented")
}
